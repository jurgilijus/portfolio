    ...
    <section name='skills' className='skills'>
      ...
      <motion.div ref={ref}
        ...
        {skillsItems.map((skillsItem) =>
          <div onClick={() => getData(skillsItem.title, skillsItem.image, skillsItem.text)} key={skillsItem.id} className='skills-item'>
        ...
        {
          model === true ? <PopupModal title={tempData[1]} image={tempData[2]} text={tempData[3]} hide={() => setModel(false)} /> : ''
        }
